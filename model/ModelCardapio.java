...
public class ModelCardapio {
    ...
    public static void consultarEstoque() {
        ...
        try {
            Connection conn = ModelMySQLConnector.conectar();
            ...
            while (rsSqlReceitas.next()) {
                ...
                if (receitaDisponivel == true) {
                    ...
                    ControllerInterfaceControler.receitasDisponiveis += receitasDisponiveis;
                    
                } else {
                    receitasIndisponiveis = ("[" + numReceita + "] - " + nomeReceita + " - indisponível.");
                    ControllerInterfaceControler.receitasIndisponiveis += receitasIndisponiveis;
                }
                numReceita++;
